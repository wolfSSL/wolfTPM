...
#if !defined(WOLFTPM2_NO_WRAPPER) && !defined(WOLFTPM2_NO_WOLFCRYPT) && !defined(NO_WOLFSSL_SERVER) && !defined(WOLFCRYPT_ONLY) && (defined(WOLFTPM_CRYPTOCB) || defined(HAVE_PK_CALLBACKS))
...
#endif
      /* !WOLFTPM2_NO_WRAPPER && !WOLFTPM2_NO_WOLFCRYPT && !NO_WOLFSSL_SERVER \
        * && !WOLFCRYPT_ONLY */
